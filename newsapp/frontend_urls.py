...
urlpatterns = [
    ...
    # -- File downloads (planning & readme) -----------------------------
    path("download/planning/", views.download_planning, name="download-planning"),
    path("download/readme/", views.download_readme, name="download-readme"),
]
