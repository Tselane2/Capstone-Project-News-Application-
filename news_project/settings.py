...
# Trust the Replit preview domain and any custom domains listed in CSRF_TRUSTED_ORIGINS.
# Django 4+ requires explicit trusted origins for CSRF on cross-origin POST requests.
# Include both the bare domain and the :8000 variant because the Replit iframe sends
# the port in the Origin header when the dev server runs on a non-standard port.
...
# ---------------------------------------------------------------------------
# Database — Development: SQLite (active)
# ---------------------------------------------------------------------------
DATABASES = {
    'default': {
...
# ---------------------------------------------------------------------------
# Database — Production: MariaDB (uncomment and fill in credentials to use)
# ---------------------------------------------------------------------------
# DATABASES = {
#     'default': {
